...
import com.bookeey.wallet.live.login.FingerprintAuthenticationDialogFragmentNewFlow;
...
import newflow_processing.CustomerLoginProcessingNewFlow;
 ...
 */
public class LoginActivityNewFlow extends FragmentActivity implements YPCHeadlessCallback {
    ...
    @Inject
    FingerprintAuthenticationDialogFragmentNewFlow mFragment;
    @Inject
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_newflow);
...
//        showMenu(false);
        ...
        if (selectedLanguage != null && !selectedLanguage.isEmpty()) {
            LocaleHelper.setLocale(LoginActivityNewFlow.this, selectedLanguage);
        }
       ...
       /* String regid = getRegistrationId(LoginActivity.this);
        ...
        final EditText login_mobile_number = (EditText) findViewById(R.id.login_mobile_number);



        login_mobile_number.setText(getIntent().getStringExtra(KEY_MOBILE_NUMBER));
...
//        login_password.setText("1234");
        ...
        language_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (language_text.getText().toString().equals("English")) {
                    ...
                    LocaleHelper.setLocale(LoginActivityNewFlow.this, "en");
                    refresh(LoginActivityNewFlow.this, "en");
                    ...
                    LocaleHelper.setLocale(LoginActivityNewFlow.this, "ar");
                    refresh(LoginActivityNewFlow.this, "ar");
                }
            }
        });
      ...
      /* String regid = getRegistrationId(LoginActivity.this);
       ...
       if (regid.isEmpty()) // if blank, then app is not yet registered
       {
        ...
        login_user_id.setVisibility(View.INVISIBLE);
        ...
        findViewById(R.id.login_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String mobile_number = login_mobile_number.getText().toString();


                if (mobile_number.length() == 0) {
                    Toast toast = Toast.makeText(LoginActivityNewFlow.this, getResources().getString(R.string.mobile_bill_L1_enter_mobile_number), Toast.LENGTH_SHORT);
                ...
                if (password.length() == 0) {
                    Toast toast = Toast.makeText(LoginActivityNewFlow.this, getResources().getString(R.string.login_password_msg), Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 400);
                    toast.show();
                    return;
                }
...
//                String mobile_number = CustomSharedPreferences.getStringData(getApplicationContext(), CustomSharedPreferences.SP_KEY.MOBILE_NUMBER);
                ...
                String uiProcessorReference = application.addUserInterfaceProcessor(new CustomerLoginProcessingNewFlow(clr, true, application));
...
//                }
        ...
        forgotpassword_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
//                LoginActivityNewFlow.this.finish();
            }
        });
...
//                        Toast.makeText(this, "Your Device does not have a Fingerprint Sensor", Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    if (!mFragment.isAdded()) {
                        ...
                        boolean isFingerprintPermissionGranted = ActivityCompat.checkSelfPermission(
                                LoginActivityNewFlow.this, Manifest.permission.USE_FINGERPRINT)
                        ...
                        if (!isFingerprintPermissionGranted || !isFingerprintAvailable) {
                            ...
                            mFragment.setStage(
                                    FingerprintAuthenticationDialogFragmentNewFlow.Stage.PASSWORD);
                            ...
                            if (useFingerprintPreference) {
                                mFragment.setStage(
                                        FingerprintAuthenticationDialogFragmentNewFlow.Stage.FINGERPRINT);
                            } else {
                                mFragment.setStage(
                                        FingerprintAuthenticationDialogFragmentNewFlow.Stage.PASSWORD);
                            }
                            ...
                            mFragment.setCryptoObject(new FingerprintManagerCompat.CryptoObject(mCipher));
                            mFragment.setStage(
                                    FingerprintAuthenticationDialogFragmentNewFlow.Stage.NEW_FINGERPRINT_ENROLLED);
                            mFragment.show(getFragmentManager(), DIALOG_FRAGMENT_TAG);
                        }
                    }
                } catch (Exception e) {
    ...
    private void refresh(LoginActivityNewFlow loginActivity, String selectedLanguage) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Intent refresh = new Intent(this, LoginActivityNewFlow.class);
    ...
    private void registerInBackground() {
        new AsyncTask<String, Void, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(LoginActivityNewFlow.this);
                    }
                    ...
                    storeRegistrationId(LoginActivityNewFlow.this, regId);
                    msg = regId;
            ...
            protected void onPostExecute(String msg) {
                ...
                CustomSharedPreferences.saveGCMRegId(LoginActivityNewFlow.this, msg, CustomSharedPreferences.SP_KEY.GCM_REG_ID);
