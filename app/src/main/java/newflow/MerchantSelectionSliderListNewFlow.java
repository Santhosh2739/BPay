 ...
 */
public class MerchantSelectionSliderListNewFlow extends ListFragment {
    public static final String tag = MerchantSelectionSliderListNewFlow.class.getCanonicalName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.e("WhereToPay URL",""+buffer.toString());
        ...
        android.os.Handler messageHandler = new android.os.Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.arg1 == ServerConnection.OPERATION_SUCCESS) {
                    ...
                    //Dec 11 Ali Ali
                    if(getActivity()!=null) {
                        Toast.makeText(getActivity(), getString(R.string.failure_network_error), Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(getActivity(), "Failure network error!", Toast.LENGTH_SHORT).show();
                    }
                ...
                if (msg.arg1 == ServerConnection.OPERATION_SUCCESS) {
                    ...
                    if (null != response && response.getG_status() == 1) {
                        ...
                        if (merchantListResponse.getMerchantDetails().size() == 0) {
                            ...
                            Intent intent = new Intent(getActivity(), MainActivityNewFlow.class);
                            startActivity(intent);
                        } else {
                            setListShown(true);
                            Intent intent = new Intent(getActivity(), MerchantListCatogorieyActivityNewFlow.class);
                            startActivity(intent);
