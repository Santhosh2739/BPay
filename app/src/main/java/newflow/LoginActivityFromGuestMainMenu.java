...
import com.bookeey.wallet.live.login.FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu;
...
public class LoginActivityFromGuestMainMenu extends FragmentActivity implements YPCHeadlessCallback {
    ...
    @Inject
    FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu mFragment;
    @Inject
...
//                            Jan 20 Touch ID Crash
                    ...
                    Toast.makeText(LoginActivityFromGuestMainMenu.this, " Fingerprint Sensor Exc: "+e.getMessage(), Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    if (!mFragment.isAdded()) {
                        ...
                        boolean isFingerprintPermissionGranted = ActivityCompat.checkSelfPermission(
                                LoginActivityFromGuestMainMenu.this, Manifest.permission.USE_FINGERPRINT)
                        ...
                        if (!isFingerprintPermissionGranted || !isFingerprintAvailable) {
                            ...
                            mFragment.setStage(
                                    FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu.Stage.PASSWORD);
                            ...
                            if (useFingerprintPreference) {
                                mFragment.setStage(
                                        FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu.Stage.FINGERPRINT);
                            } else {
                                mFragment.setStage(
                                        FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu.Stage.PASSWORD);
                            }
                            ...
                            mFragment.setCryptoObject(new FingerprintManagerCompat.CryptoObject(mCipher));
                            mFragment.setStage(
                                    FingerprintAuthenticationDialogFragmentLoginFromGuestMainMenu.Stage.NEW_FINGERPRINT_ENROLLED);
                            mFragment.show(getFragmentManager(), DIALOG_FRAGMENT_TAG);
                        }
                    }
                } catch (Exception e) {
    ...
    private void registerInBackground() {
        new AsyncTask<String, Void, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(LoginActivityFromGuestMainMenu.this);
                    }
                    ...
                    storeRegistrationId(LoginActivityFromGuestMainMenu.this, regId);
                    msg = regId;
            ...
            protected void onPostExecute(String msg) {
                ...
                CustomSharedPreferences.saveGCMRegId(LoginActivityFromGuestMainMenu.this, msg, CustomSharedPreferences.SP_KEY.GCM_REG_ID);
