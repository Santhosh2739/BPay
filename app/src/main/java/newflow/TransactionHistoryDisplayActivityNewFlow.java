...
import com.bookeey.wallet.live.txnhistory.TransactionHistoryDisplayActivity;
...
public class TransactionHistoryDisplayActivityNewFlow extends GenericActivity implements YPCHeadlessCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transaction_display_newflow);
...
//                df.setRoundingMode(RoundingMode.CEILING);
                ...
                if (domesticRechargeTranHistoryResponsePojo.getTotalRedemptionPoints() != null) {
                    ...
                    prepaid_cards_bpoints_balance_linear.setVisibility(View.GONE);
...
//                balanceafter_linear.setVisibility(View.GONE);
                ...
                ooredoo_transaction_screen_time_txt  = (TextView) findViewById(R.id.ooredoo_transaction_screen_time_txt);
                ooredoo_transaction_screen_time_txt.setVisibility(View.GONE);
                LinearLayout  receiptername_linear= (LinearLayout)findViewById(R.id.receiptername_linear);
                receiptername_linear.setVisibility(View.GONE);
...
//                df.setRoundingMode(RoundingMode.CEILING);
                ...
                if (domesticRechargeTranHistoryResponsePojo1.getTotalRedemptionPoints() != null) {
                    ...
                    bpoints_balance_horizontal5.setVisibility(View.GONE);
                    ...
                    bpoints_balance_linear_dom_recharge_linear.setVisibility(View.GONE);
...
//                bpoints_right.setText("" + df.format(bpoints));
            ...
            case ECOMMERCE_TRAN_RESPONSE:
                ...
                ecom_mer_name_hor_view = (View) findViewById(R.id.ecom_mer_name_hor_view);
                ecom_mer_name_hor_view.setVisibility(View.GONE);
            ...
            case PREPAID_REQUESTCARD_RESPONSE:
                ...
                LinearLayout processingfee_linear = (LinearLayout)findViewById(R.id.processingfee_linear) ;
                processingfee_linear .setVisibility(View.GONE);
...
//                df.setRoundingMode(RoundingMode.CEILING);
                ...
                if (transactionalHistoryForInternationalRecharge.getTotalRedemptionPoints() != null) {
                    ...
                    bpoints_balance_horizontal6.setVisibility(View.GONE);
                    LinearLayout bpoints_balance_linear = (LinearLayout) findViewById(R.id.bpoints_balance_linear);
                    bpoints_balance_linear.setVisibility(View.GONE);
            ...
            case INTERNATIONAL_RECHARGE_L2_RESPONSE:
                ...
                if(transactionalHistoryForInternationalRecharge.getLocalCurrency()!=null) {
                    ...
                    right3.setText(""+ PriceFormatter.format(Double.parseDouble(transactionalHistoryForInternationalRecharge.getDenominationAmt()), 2, 2));
...
//                left5.setText(getResources().getString(R.string.txn_amount_kwd));
        ...
        close_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TransactionHistoryDisplayActivityNewFlow.this.finish();
            }
        });
    }
