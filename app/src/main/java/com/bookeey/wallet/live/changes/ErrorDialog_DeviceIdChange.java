 ...
 */
public class ErrorDialog_DeviceIdChange extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.Oorredoo_dialog_change_device_tv)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Intent intent = new Intent(getBaseContext(), DevChangeDeviceNumber.class);
                    startActivity(intent);
                    ErrorDialog_DeviceIdChange.this.finish();
                }
        });
    }
}