 ...
 */
public class OoredooValidation extends FragmentActivity implements YPCHeadlessCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedLanguage != null && !selectedLanguage.isEmpty()) {
            LocaleHelper.setLocale(OoredooValidation.this, selectedLanguage);
        }
        ...
        mobile_number_validation_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mobile_number_validation_edit.getText().toString().trim().length() == 0) {
                    Toast toast = Toast.makeText(OoredooValidation.this,getResources().getString(R.string.mob_validation_enter_mobile_no), Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 400);
                    toast.show();
                    return;
                }
                if (mobile_number_validation_edit.getText().toString().trim().length() != 8) {
                    Toast toast = Toast.makeText(OoredooValidation.this,getResources().getString(R.string.mob_validation_enter_valid_mobile_no), Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 400);
                    toast.show();
                    return;
                }
        ...
        language_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (language_text.getText().toString().equals("English")) {
                    ...
                    LocaleHelper.setLocale(OoredooValidation.this, "en");
                    refresh(OoredooValidation.this, "en", mobileNumber);
                    ...
                    LocaleHelper.setLocale(OoredooValidation.this, "ar");
                    refresh(OoredooValidation.this, "ar", mobileNumber);
                }
            }
        });
    ...
    private void refresh(OoredooValidation ooredooValidation, String selectedLanguage, String mobileNumber) {
