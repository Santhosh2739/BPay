...
import coreframework.utils.VerticalTextView;
 ...
 */
public class TransactionHistoryActivity extends GenericListActivity implements DownloadResultReceiver.Receiver, YPCHeadlessCallback {
        ...
        if (null != type) {
            switch (type) {
                case SEND_MONEY_REQUEST_RESPONSE:
                    ...
                    intent.setClass(this, TransactionHistoryDisplayActivity.class);
                    break;
