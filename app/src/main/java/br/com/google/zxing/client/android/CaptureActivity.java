...
import br.com.google.zxing.client.android.camera.CameraManager;
import br.com.google.zxing.client.android.result.ResultHandler;
import br.com.google.zxing.client.android.result.ResultHandlerFactory;
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if (source == IntentSource.NATIVE_APP_INTENT) {
				...
				finish();
				return true;
			} else if ((source == IntentSource.NONE) && lastResult != null) {
