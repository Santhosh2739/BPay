...
public final class QRCodeWriter implements Writer {
	...
	public static ByteMatrix renderResult(QRCode code, int width, int height) {
		...
		int outputWidth = width;//Math.max(width, qrWidth);
		int outputHeight = height;//Math.max(height, qrHeight);
