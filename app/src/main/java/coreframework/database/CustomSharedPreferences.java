...
public class CustomSharedPreferences {
    ...
    public enum SP_KEY {
        ...
        FNAME, LNAME, CIVILDID, EMIALID,LANGUAGE,LANGUAGE_TO_BE_DISPLAYED,TEST_PIN,PASSWORD,ENC_PASSWORD,MOBILEBILL_RESPONSE,PREPAID_RESPONSE,BPOINTS,CURRENT_LATITUTE,CURRENT_LONGITUDE,PREVIOUS_CAT_TAG,MODULE
    }
