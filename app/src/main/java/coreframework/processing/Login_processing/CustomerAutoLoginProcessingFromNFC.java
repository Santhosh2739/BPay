...
public class CustomerAutoLoginProcessingFromNFC implements UserInterfaceBackgroundProcessing {
    ...
    private boolean isAutoLoginFromNFC = false;

    public CustomerAutoLoginProcessingFromNFC(CustomerLoginRequest loginRequest, boolean isPost, CoreApplication application,boolean isAutoLoginFromNFC) {
        this.loginRequest = loginRequest;
        this.isPost = isPost;
        this.application = application;
        this.isAutoLoginFromNFC =true;
    }
...
//                intent.putExtra(MainActivity.KEY_FROM_LOGIN, true);
                CustomSharedPreferences.saveBooleanData(activity, false, CustomSharedPreferences.SP_KEY.COMING_FROM_LOGIN);
                CustomSharedPreferences.saveBooleanData(activity, true, CustomSharedPreferences.SP_KEY.SESSION_EXPIRED);
                CustomSharedPreferences.saveBooleanData(activity, true, CustomSharedPreferences.SP_KEY.KEY_IS_AUTO_LOGIN_FROM_NFC);
