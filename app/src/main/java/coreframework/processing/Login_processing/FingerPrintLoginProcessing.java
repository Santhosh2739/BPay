 ...
 */
public class FingerPrintLoginProcessing implements UserInterfaceBackgroundProcessing {
    ...
    public FingerPrintLoginProcessing(CustomerLoginRequest loginRequest, boolean isPost, CoreApplication application) {
    ...
    public String captureURL() {
        ...
        loginRequest.setG_transType(TransType.BIO_LOGIN_CUSTOMER_REQUEST.name());
