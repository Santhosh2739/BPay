...
public class StaticQRCodePaymentConfirmationScreenCX extends GenericActivity implements YPCHeadlessCallback, View.OnClickListener {


    private FirebaseAnalytics firebaseAnalytics;

    private String response, mref_Id = null;
    private PayToMerchantCommitRequestResponse response_obj = null;

    public static final String KEY_MER_REF_ID = "KEY_MER_REF_ID";
    ...
    TextView static_qr_p2m_merchant_name,static_qr_p2m_txn_id,static_qr_p2m_branch,static_qr_p2m_offer_desc,
            static_qr_p2m_amount_due,static_qr_p2m_discount_amount,static_qr_p2m_amount_paid,static_qr_p2m_after_balance,
            static_qr_p2m_status,static_qr_p2m_txn_time,static_qr_p2m_amount_paid_header;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.static_qr_p2m_confirmation);
        ...
        if (selectedLanguage != null && !selectedLanguage.isEmpty()) {
            LocaleHelper.setLocale(StaticQRCodePaymentConfirmationScreenCX.this, selectedLanguage);
        }
       ...
       /* View mCustomView = getActionBar().getCustomView();
        ...
        mTitleTextView.setText(getString(R.string.confirm_to_pay));
        ...
        mref_Id = getIntent().getExtras().getString(KEY_MER_REF_ID);
...
//Discount Amount
        ...
        accept_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PayToMerchantStaticQRConfirm payToMerchantConfirmRequest = new PayToMerchantStaticQRConfirm();
                payToMerchantConfirmRequest.setTransactionId(response_obj.getTransactionId());
                payToMerchantConfirmRequest.setMerchantRefNumber(mref_Id);
...
//                payToMerchantConfirmRequest.setClientDate(currentLocalTime);

                //Code to start server thread and display the progress fragment dialogue (retained)
                CoreApplication application = (CoreApplication) getApplication();
                String uiProcessorReference = application.addUserInterfaceProcessor(new PayToMerchantStaticQRCodeConfirmProcessing(payToMerchantConfirmRequest, application, true));
