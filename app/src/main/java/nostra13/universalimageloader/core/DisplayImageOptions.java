...
import nostra13.universalimageloader.core.display.BitmapDisplayer;
import nostra13.universalimageloader.core.display.SimpleBitmapDisplayer;
 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link nostra13.universalimageloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link nostra13.universalimageloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <ul>
 * <li>with {@link nostra13.universalimageloader.core.DisplayImageOptions.Builder}:<br />
 * <b>i.e.</b> :
 * <code>new {@link nostra13.universalimageloader.core.DisplayImageOptions}.{@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#Builder() Builder()}.{@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#cacheInMemory() cacheInMemory()}.
 * {@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int) showImageOnLoading()}.{@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#build() build()}</code><br />
 * </li>
...
public final class DisplayImageOptions {
	...
	/**
	 * Builder for {@link nostra13.universalimageloader.core.DisplayImageOptions}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in {@link nostra13.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in {@link nostra13.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in {@link nostra13.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		 * This option will be ignored if {@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if {@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if {@link nostra13.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		...
		/**
		 * {@link nostra13.universalimageloader.core.imageaware.ImageAware
		...
		/** Builds configured {@link nostra13.universalimageloader.core.DisplayImageOptions} object */
