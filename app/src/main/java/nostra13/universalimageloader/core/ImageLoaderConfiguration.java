...
import nostra13.universalimageloader.cache.disc.DiskCache;
import nostra13.universalimageloader.cache.disc.naming.FileNameGenerator;
import nostra13.universalimageloader.cache.memory.MemoryCache;
import nostra13.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import nostra13.universalimageloader.core.assist.FlushedInputStream;
...
import nostra13.universalimageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>threadPoolSize = {@link nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
	 * <li>threadPriority = {@link nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
	 ...
	 * <li>diskCache = {@link nostra13.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	/**
	 * Builder for {@link nostra13.universalimageloader.core.ImageLoaderConfiguration}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, nostra13.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link nostra13.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(nostra13.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link nostra13.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(nostra13.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link nostra13.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link nostra13.universalimageloader.utils.StorageUtils#getCacheDirectory(android.content.Context)
		 ...
		 * Default value -
		 * {@link nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(android.content.Context)
		 ...
		 * Default value -
		 * {@link nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link nostra13.universalimageloader.utils.L#disableLogging()} to disable
		...
		/** Builds configured {@link nostra13.universalimageloader.core.ImageLoaderConfiguration} object */
	 ...
	 * using {@link nostra13.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
