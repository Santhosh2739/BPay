...
import nostra13.universalimageloader.core.assist.FailReason.FailType;
...
import nostra13.universalimageloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link nostra13.universalimageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	/**
	 * @throws nostra13.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if task is not actual (target ImageAware is collected by GC or the image URI of
	...
	/** @throws nostra13.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if target ImageAware is collected */
	...
	/** @throws nostra13.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if target ImageAware is collected by GC */
	...
	/** @throws nostra13.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if current task was interrupted */
