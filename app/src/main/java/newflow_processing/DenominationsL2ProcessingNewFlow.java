package newflow_processing;//package coreframework.processing.mobile;
//
...
//import com.bookeey.wallet.live.mobilebill.MobileBill_Final_Screen;
//import com.bookeey.wallet.live.mobilebill.MobileBill_L2_Activity;
//import com.bookeey.wallet.live.mobilebill.MobileBill_List_Activity;
...
// */
//
//public class DenominationsL2ProcessingNewFlow implements UserInterfaceBackgroundProcessing {
//
...
//
//    public DenominationsL2ProcessingNewFlow(DomesticL2RequestPojo request, CoreApplication application, boolean isPost) {
...
//        this.request.setG_transType(TransType.NEW_DOMESTIC_RECHARGE_L2_REQUEST.name());
//        StringBuffer buffer = new StringBuffer();
//        buffer.append(TransType.NEW_DOMESTIC_RECHARGE_L2_REQUEST.getURL());
...
//                if (response.getG_response_trans_type().equalsIgnoreCase(TransType.NEW_DOMESTIC_RECHARGE_L2_RESPONSE.name()) && response.getG_status() == 1) {
//                    this.response_json = network_response;
//                    this.success = true;
//                } else if (response.getG_response_trans_type().equalsIgnoreCase(TransType.NEW_DOMESTIC_RECHARGE_L2_RESPONSE.name()) && response.getG_status() != 1) {
...
//        if (success) {
//            Intent intent = new Intent(activity, MobileBill_Final_Screen.class);
//            intent.putExtra("DOMESTIC_L2_RESPONSE", this.response_json);
...
//                activity.finish();
//            } else {
//                String mobilebill_res= CustomSharedPreferences.getStringData(activity, CustomSharedPreferences.SP_KEY.MOBILEBILL_RESPONSE);
...
//                        toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 400);
//                        toast.show();
//                        Intent intent = new Intent(activity, MobileBill_List_Activity.class);
//                        intent.putExtra("BILL_RESPONSE", mobilebill_res);
//                        activity.startActivity(intent);
//                        break;
//                    case "Invalid tpin":
...
//                        toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 400);
//                        toast.show();
//                        intent = new Intent(activity, MobileBill_List_Activity.class);
//                        intent.putExtra("BILL_RESPONSE", mobilebill_res);
//                        activity.startActivity(intent);
//                        break;
